...
const ChatScreen = ({ navigation, route }) => {
    ...
    const handleReply = async (message) => {
        ...
        const token = await getAccessToken();
        // if (message) {
        //     fetch(`http://ec2-52-221-252-41.ap-southeast-1.compute.amazonaws.com:8555/api/v1/conservations/${conversationParams._id}/messages/replyText/${message._id}`,
        //         {
        //             method: "POST",
        //             headers: {
        //                 "Content-Type": "application/json",
                            ...
                            {replyText.isMine == true ? (
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Text>{user.name} : {replyText.content}</Text>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Text>{replyText.name} : {replyText.content}</Text>
                                        <Pressable onPress={() => cancelReply()}>
                                            <MaterialCommunityIcons name="close" size={20} color="black" />
                                        </Pressable>
